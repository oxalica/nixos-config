" Modified from:
" https://github.com/lilydjwg/dotvim/blob/64dce92c07eec53f07a8e2c478fd60a875353c67/colors/lilypink.vim
...
if version >= 700
  ...
  highlight CursorLineNr guifg=#585858 guibg=#303030 ctermfg=240 ctermbg=236 cterm=NONE
...
if version >= 703
  ...
  highlight ColorColumn guibg=#1c1c1c ctermbg=234 cterm=NONE
endif
...
highlight NonText guifg=#585858 guibg=#242424 gui=NONE ctermfg=240 ctermbg=235 cterm=NONE
" highlight LineNr guifg=#444444 guibg=#242424 gui=NONE ctermfg=238 ctermbg=235 cterm=NONE
highlight LineNr guifg=#4e4e4e guibg=#242424 gui=NONE ctermfg=239 ctermbg=235 cterm=NONE
...
highlight Special guifg=#ffddaa gui=NONE ctermfg=223 cterm=italic

" highlight IncSearch guifg=#33ff1c guibg=#000000 gui=underline ctermfg=46 ctermbg=16 cterm=underline
highlight IncSearch guifg=#33ff1c guibg=#585858 gui=underline ctermfg=46 ctermbg=240 cterm=underline
" highlight Search guifg=NONE guibg=#585858 ctermfg=NONE ctermbg=16 cterm=NONE
highlight Search guifg=NONE guibg=#585858 ctermfg=NONE ctermbg=240 cterm=NONE
...
highlight Comment guifg=#99968b gui=italic ctermfg=246 cterm=italic
...
highlight String guifg=#98ff85 gui=italic ctermfg=121 cterm=italic
...
highlight Function guifg=#ffffaf gui=NONE ctermfg=229 cterm=NONE
highlight Type guifg=#ffffaf gui=NONE ctermfg=229 cterm=NONE
